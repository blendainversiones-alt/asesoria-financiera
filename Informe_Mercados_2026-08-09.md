...
_Generado automaticamente a las 12:31 (hora Argentina)_
...
| Oro (futuro) | 4,399.70 | 4,299.60 | +2.33% |
...
| Activo | Ultimo | Cierre anterior | Variacion |
|---|---|---|---|
| Bitcoin (BTC) | 65,180.19 | 64,908.48 | +0.42% |
| Ethereum (ETH) | 1,924.81 | 1,915.44 | +0.49% |
| BNB | 608.43 | 600.41 | +1.34% |
| Solana (SOL) | 76.89 | 75.97 | +1.21% |
| XRP | 1.04 | 1.04 | +0.30% |
